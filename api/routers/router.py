...
REGISTRY: list[Mount] = [
    ...
    Mount("routers.products", description="product management"),
    Mount("routers.carts", description="carts and checkout"),
    Mount("routers.sessions", description="agentic checkout sessions"),
    Mount("routers.orders", description="orders"),
    Mount("routers.policy", description="policy dry-run evaluation"),
    Mount("routers.authorizations", description="the money gate"),
    Mount("routers.payments", description="the money mover"),
    Mount("routers.opportunities", description="growth suggestions"),
    Mount("routers.campaigns", description="campaign budget and reservations"),
    Mount("routers.admin", description="escalations, policy"),
    Mount("routers.webhooks", description="razorpay callbacks"),
    Mount("routers.reconciliation", description="ledger reconciliation"),
    Mount("routers.audit", description="hash-chained audit ledger"),
    Mount("routers.passport", description="signed transaction receipts"),
